...
class ShareViewController: SLComposeServiceViewController {
 ...
 let hostAppBundleIdentifier = "com.sigongan.bomjaguk"
 let shareProtocol = "com.sigongan.bomjaguk" //share url protocol (must be unique to your app, suggest using your apple bundle id, ie: `hostAppBundleIdentifier`)
