...
export type ImageSelectPopupHandler = {
  open: () => void;
  close: () => void;
};

type ImageSelectPopupProps = {
  onSendImagePress: (url: string) => void;
};

// eslint-disable-next-line
export const ImageSelectPopup = forwardRef<ImageSelectPopupHandler, ImageSelectPopupProps>(
  ({ onSendImagePress }, ref) => {
